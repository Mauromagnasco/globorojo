...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        textColor = [UIColor colorWithRed:0.59 green:0.59 blue:0.59 alpha:1.0];
        mentionTextColor = [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.0];
        hashtagTextColor = [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.0];
        linkTextColor = [UIColor colorWithRed:129.0/255.0 green:171.0/255.0 blue:193.0/255.0 alpha:1.0];
        
        selectedMentionTextColor = [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.0];
        selectedHashtagTextColor = [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.0];
...
- (void)touchesCancelled:(NSSet *)touches withEvent:(UIEvent *)event
{
    if(currentSelectedString != nil)
    {
        ...
        if([currentSelectedString hasPrefix:@"@"])
            [newAttrString addAttribute:NSForegroundColorAttributeName value:buttonFontColor range:currentSelectedRange];
