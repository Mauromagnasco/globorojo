...
- (CGRect) centeredOnScreenImage:(UIImage*) image {
    ...
    CGPoint imageOrigin = CGPointMake(self.view.frame.size.width/2.0 - imageSize.width, self.view.frame.size.height/2.0 - imageSize.height);
    return CGRectMake(imageOrigin.x, imageOrigin.y, imageSize.width * 2, imageSize.height * 2);
}
