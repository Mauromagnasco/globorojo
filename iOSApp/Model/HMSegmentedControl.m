...
- (void)commonInit {
    ...
    self.font = [UIFont fontWithName:CUSTOM_FONT size:13.0f];
...
//            if ((deltaT >= 0.5 && segment == 1) || (segment == 1 && segment == self.selectedSegmentIndex)) {
//                
...
//                        [[NSNotificationCenter defaultCenter] postNotificationName:@"HomeScoreDropMenu" object:nil];
//                    }else {
//                        [[NSNotificationCenter defaultCenter] postNotificationName:@"SearchScoreDropMenu" object:nil];
//                    }
//                }
//            }
            if (segment != self.selectedSegmentIndex) [self setSelectedSegmentIndex:segment animated:YES notify:YES];
        }
    }
}
