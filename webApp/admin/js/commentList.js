...
function onDeleteComment( ){
	var objList = $("table#example").find("input#chkCommentId:checkbox:checked");
	if( objList.length == 0 ){ alert("Please select Comments to delete."); return;}
	var strIds = "";
    ...
    $.ajax({
        url: "async-deleteComment.php",
        dataType : "json",
        type : "POST",
        data : { commentIds : strIds },
